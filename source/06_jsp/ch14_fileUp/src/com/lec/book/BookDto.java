...
public class BookDto {
	...
	private Date brdate;
	public BookDto() {} // setter 파일첨부에서는 매개변수 없는 생성자 필요X
	...
	public String toString() {
		return "BookDto [bid=" + bid + ", 제목=" + btitle + ", 가격=" + bprice + ", bimage1=" + bimage1
				+ ", bimage2=" + bimage2 + ", 설명=" + bcontent + ", 할인율=" + bdiscount + ", 등록일=" + brdate
				+ "]";
	}
}
