...
<body>
	...
	<table>
		...
		<tr><th>상사사번</th><td>${empDto.mgr==0? '':empDto.mgr }</td></tr>
		<tr>
			<th>입사일</th>
		...
		<tr>
			<th>상여</th>
			<td><fmt:formatNumber value="${empDto.comm }" groupingUsed="true"/></td>
		</tr>
		<tr><th>부서번호</th><td>${empDto.deptno }</td></tr>
		<tr>
			<td colspan="2">
				<button onclick="location.href='${conPath}/empDeptList.do?pageNum=${param.pageNum }'">목록</button>
				<button onclick="location.href='${conPath}/updateView.do?empno=${param.empno }&pageNum=${param.pageNum }'">수정</button>
